...
const PrimaryEducation = () => {
  ...
  const breadcrumbs = [
    ...
    { label: 'الشهادة الابتدائية', href: '/services/education/primary' }
  ];

  // Service configuration for Primary Education
  const service = {
    id: 'primary',
    title: 'امتحانات الشهادة الابتدائية',
    description: 'التقديم لامتحانات شهادة إتمام مرحلة الأساس (الصف الثامن)',
    icon: 'BookOpen',
    category: 'education',
    requirements: [
      'تقديم أصل شهادة الصف الخامس مرّ عليها عام',
      'صورة شخصية حديثة',
      'الرقم الوطني، ولغير السودانيين صورة جواز السفر',
      'التأكد من إدخال البيانات صحيحة',
      'لن يكتمل التسجيل حال نقص المستندات'
    ],
    fees: '450 ريال',
    duration: '3-4 أشهر',
    steps: [
      ...
      },
      {
        ...
        fields: [
          {
            name: 'gradePhoto',
            label: 'أصل شهادة الصف الخامس',
            type: 'file',
            accept: '.pdf,.jpg,.jpeg,.png',
            required: true,
            maxSize: '5MB',
            validation: { required: 'شهادة الصف الخامس مطلوبة' }
          },
          {
            name: 'personalPhoto',
          ...
          },
          {
            ...
            validation: { required: 'صورة جواز السفر مطلوبة' }
          }
        ]
      }
    ]
  ...
  const fillTestData = () => {
    setFormData({
      ...
      motherName: 'فاطمة عبدالله محمد أحمد',
      schoolName: 'مدرسة النيل الابتدائية',
      examLanguage: 'arabic',
      specialCase: '',
      ...
      addressCity: 'جدة',
      addressDistrict: 'الروضة',
      addressLandmark: 'بجانب مسجد الروضة',
      guardianName: 'محمد علي حسن',
      guardianWorkplace: 'شركة الاتصالات السعودية',
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      console.log('Primary Education Application:', { ...formData, referenceNumber });
      setIsSubmitting(false);
      
      navigate('/success', { 
        state: { 
          referenceNumber, 
          serviceTitle: 'امتحانات الشهادة الابتدائية' 
        } 
      });
    }, 2000);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 text-center px-4">
              <h1 className="text-2xl sm:text-3xl font-bold">امتحانات الشهادة الابتدائية</h1>
            </div>
